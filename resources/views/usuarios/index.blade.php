...
@section('content')
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
            ...
            <h1 class=" text-black text-3xl p-8 font-bold">Usuarios registrados en el sistema</h1>
            <div class="relative overflow-x-auto p-8">
                <div class="flex gap-8 mt-10  ">
                    <a href="{{ route('user.create') }}">
                        <button
                            class=" bg-green-500 flex gap-2 hover:bg-green-400   text-white font-bold p-4 mb-8 rounded-md">
                            Crear usuario
                        </button>
                    </a>
                </div>

                <table class="w-full text-sm text-left text-white rounded-md">
                    ...
                    @foreach ($usuarios as $usuario)
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 user-row">
                                <td scope="row"
